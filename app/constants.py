...
class SIZE:
    ...
    TOKEN_SAVE_BUTTON = Size(ENTRY_HEIGHT - 7, ENTRY_HEIGHT)
    TOKEN_ENTRY = Size(WINDOW_WIDTH - WINDOW_MARGIN * 1.5 - LARGE_GAP - TOKEN_SAVE_BUTTON.w - FRAME_GAP, ENTRY_HEIGHT)
...
POS.TOKEN_SAVE_BUTTON = Pos(POS.TOKEN_ENTRY.x + SIZE.TOKEN_ENTRY.w + FRAME_GAP, POS.TOKEN_ENTRY.y + (SIZE.TOKEN_ENTRY.h - SIZE.TOKEN_SAVE_BUTTON.h) / 4)
