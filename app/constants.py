...
SIZE.LOGS_TEXTBOX = Size(SIZE.LOGS_PANEL.w - FRAME_GAP * 2, SIZE.LOGS_PANEL.h * 0.91 - TINY_GAP)
SIZE.LOGS_ENTRY = Size(SIZE.LOGS_TEXTBOX.w * 0.8 - FRAME_GAP, SIZE.LOGS_PANEL.h - SIZE.LOGS_TEXTBOX.h - FRAME_GAP - FRAME_GAP * 2)
...
class OFFSET:
    ...
    INVALID_INPUT = Pos(10, -25 + (FONT_SIZE.ENTRY_TOOLTIP - FONT_SIZE.INVALID_INPUT))
...
OFFSET.LOGS_TEXTBOX = Pos(FRAME_GAP, FRAME_GAP)
...
OFFSET.LOGS_AUTO_SCROLL_SWITCH = Pos(SIZE.LOGS_TEXTBOX.w - SIZE.LOGS_AUTO_SCROLL_SWITCH.w - FRAME_GAP * 2, OFFSET.LOGS_TEXTBOX.y + FRAME_GAP)
