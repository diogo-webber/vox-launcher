...
SIZE.LOGS_TEXTBOX = Size(SIZE.LOGS_PANEL.w - FRAME_GAP * 2, SIZE.LOGS_PANEL.h * 0.83 - FRAME_GAP)
...
OFFSET.LOGS_TOP_BAR = Pos(FRAME_GAP, FRAME_GAP/1.5)
...
OFFSET.LOGS_AUTO_SCROLL_SWITCH = Pos(SIZE.LOGS_TEXTBOX.w - SIZE.LOGS_AUTO_SCROLL_SWITCH.w - FRAME_GAP * 3, 0)
