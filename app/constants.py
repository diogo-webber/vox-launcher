...
class SIZE:
    ...
    LOGS_SHOW_END_BUTTON = Size(36, 36)
...
SIZE.LOGS_SEARCH_BUTTON = Size(28, 28)
SIZE.LOGS_SEARCH_DIVIDER = Size(2, 20)
SIZE.LOGS_SEARCH_ENTRY = Size(185, SIZE.LOGS_SEARCH_BUTTON.h)
SIZE.LOGS_SEARCH_BAR = Size(400, SIZE.LOGS_SEARCH_BUTTON.h + FRAME_GAP * 1.6)
...
class OFFSET:
    ...
    SHARD_STATUS_MSG = Pos(SIZE.FRAME.w * 0.85, SIZE.FRAME.h / 2)
...
# The bar is centred in the strip above the textbox, then nudged down so it reads level.
LOGS_TOP_BAR_GAP = SIZE.LOGS_TOP_BAR.h / 8
LOGS_TOP_BAR_NUDGE = 2

OFFSET.LOGS_TOP_BAR = Pos(FRAME_GAP, LOGS_TOP_BAR_GAP + LOGS_TOP_BAR_NUDGE)
OFFSET.LOGS_TEXTBOX = Pos(FRAME_GAP, LOGS_TOP_BAR_GAP * 2 + SIZE.LOGS_TOP_BAR.h)
...
# These float on top of the textbox, so they are relative to the panel like every other offset here.
OFFSET.LOGS_SHOW_END_BUTTON = Pos(OFFSET.LOGS_TEXTBOX.x + SIZE.LOGS_TEXTBOX.w - SIZE.LOGS_SHOW_END_BUTTON.w - FRAME_GAP * 2, OFFSET.LOGS_TEXTBOX.y + SIZE.LOGS_TEXTBOX.h - SIZE.LOGS_SHOW_END_BUTTON.h - FRAME_GAP * 2)
OFFSET.LOGS_SEARCH_BAR = Pos(OFFSET.LOGS_TEXTBOX.x + SIZE.LOGS_TEXTBOX.w - SIZE.LOGS_SEARCH_BAR.w - FRAME_GAP * 3, OFFSET.LOGS_TEXTBOX.y + FRAME_GAP)
OFFSET.LOGS_AUTO_SCROLL_SWITCH = Pos(SIZE.LOGS_TEXTBOX.w - SIZE.LOGS_AUTO_SCROLL_SWITCH.w - FRAME_GAP * 3, (OFFSET.LOGS_TEXTBOX.y - SIZE.LOGS_AUTO_SCROLL_SWITCH.h) / 2 + LOGS_TOP_BAR_NUDGE)
...
POS.TOKEN_TOOLTIP = Pos(WINDOW_WIDTH - WINDOW_MARGIN - SIZE.TOKEN_TOOLTIP.w - FRAME_GAP, POS.TOKEN_ENTRY.y + (SIZE.TOKEN_ENTRY.h - SIZE.TOKEN_TOOLTIP.h)/2)
